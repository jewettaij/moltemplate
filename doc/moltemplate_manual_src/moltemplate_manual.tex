...
write("Data Atoms") {
  $atom:c  $mol:. @atom:C4  -0.18  0.0000  0.0000   0.0000
  $atom:h1 $mol:. @atom:H1   0.06  0.0000  0.6310   0.8924
  $atom:h2 $mol:. @atom:H1   0.06  0.0000  0.6310  -0.8924
  $atom:h3 $mol:. @atom:H1   0.06 -0.8924 -0.6310   0.0000
       :       :       :
}
\end{verbatim}
