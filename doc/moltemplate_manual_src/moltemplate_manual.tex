...
You can install both moltemplate and LAMMPS in windows, but you will first need to install the \textit{BASH} shell environment on your computer.
...
\hline
-molc &
Helpful additional post-processing for users of the MOLC coarse-grained model.
\\
\end{longtable}
...
\begin{verbatim}
wat  = new SPCE [10].move(0.00, 0.00, 3.1034) 
                [10].move(0.00, 3.1034, 0.00) 
                [10].move(3.1034, 0.00, 0.00)
\end{verbatim}
