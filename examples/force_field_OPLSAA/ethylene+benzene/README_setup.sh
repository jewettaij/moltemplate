...
cd moltemplate_files
  ...
  # (Optional: To check for missing angle & dihedral interactions use -checkff)
  ...
  # system.in.settings and system.in.data files, run the following script:
  ...
  # (Don't do this until after you have run "moltemplate_cleanup.sh")
  rm -rf output_ttree/
