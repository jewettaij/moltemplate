...
Charges can also be downloaded from the RED server

https://upjv.q4md-forcefieldtools.org/REDServer/

The charges stored in the resulting MOL2 files can be extracted using the
[mol22lt.py program](../../../doc/doc_mol22lt.md),
which is included with moltemplate.
***(WARNING: This program is experimental as of 2022-8-15.)***
