...
##############
ofile = open('tabulated_potential', 'w')
tot_potential_hh = zeros((r_max / r_space + 1, 4))
tot_potential_ht = zeros((r_max / r_space + 1, 4))
tot_potential_tt = zeros((r_max / r_space + 1, 4))
